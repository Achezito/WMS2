...
<body>
    ...
    <div id="button-cards-container">
        <a href="../formularios/prestamos.php" style="text-decoration: none; color: inherit;">
            <div class="button-card">
                <i class="fas fa-hand-holding"></i> Préstamos
            </div>
        </a>
        <a href="../formularios/transacciones.php" style="text-decoration: none; color: inherit;">
            <div class="button-card">
                <i class="fas fa-exchange-alt"></i> Transacciones
            </div>
        </a>
        <a href="../formularios/mantenimiento.php" style="text-decoration: none; color: inherit;">
            <div class="button-card">
