<?php
session_start();
require_once('C:/xampp/htdocs/WMS2/WMS2/LandingPage/phpFiles/Models/personal.php');

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Sanitiza el nombre de usuario
    $userFetch = htmlspecialchars($_POST['username'], ENT_QUOTES, 'UTF-8');

    $emailFetch = htmlspecialchars($_POST['email'], ENT_QUOTES, 'UTF-8');
    ...
    $userPersonal = Personal::login($userFetch, $emailFetch ,$passwordFetch);
    ...
    if ($userPersonal instanceof Personal) {
        ...
        header("Location: /WMS2/WMS2/LandingPage/html/index.php");
        exit();
    } else {
        ...
        header("Location: /WMS2/WMS2/LandingPage/html/login.php");
        exit();
    }
}
